...
if (!BS_URL || !BS_CLIENT_ID || !BS_AUTH_ENDPOINT || !BS_TOKEN_ENDPOINT || !BS_KEYSET_URL) {
  console.error('❌ ERRO: Variáveis BS_* (dados da plataforma Brightspace) estão incompletas.');
  process.exit(1);
}
